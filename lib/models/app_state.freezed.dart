...
class _$AppStateDataImpl extends _AppStateData {
  _$AppStateDataImpl(
      ...
      @HiveField(1) this.theme = "system",
      @HiveField(2) this.autoLoginResult})
      : super._();
  ...
  @override
  String toString() {
    return 'AppStateData(navigatorIndex: $navigatorIndex, theme: $theme, autoLoginResult: $autoLoginResult)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, navigatorIndex, theme, autoLoginResult);
...
abstract class _AppStateData extends AppStateData {
  factory _AppStateData(
      ...
      @HiveField(1) final String theme,
      @HiveField(2) final bool? autoLoginResult}) = _$AppStateDataImpl;
